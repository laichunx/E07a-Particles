...
class Particle(arcade.Sprite):
    def __init__(self, asset, scale, x, y, dx, dy, ax, ay, decay):
        ...
        self.particle_colors = [
            (open_color.cyan_6, 4)
            ,(open_color.blue_4, 5)
            ,(open_color.indigo_7, 6)
            ,(open_color.lime_3, 7)
            ,(open_color.lime_7, 8)
            ,(open_color.green_7, 8)
            ,(open_color.cyan_3, 7)
            ,(open_color.yellow_3, 6)
            ,(open_color.yellow_8, 5)
            ,(open_color.orange_9, 4)
        ]
...
class Window(arcade.Window):
    ...
    def update(self, delta_time):
        ...
        if self.mouse_down:
            ...
            particle = Particle('smoke_10',scale,x,y,dx,dy,ax,ay,decay)
